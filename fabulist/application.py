...
from fabulist.controllers import ActivityController, AuthorController, BibliographyController, ChapterController, \
...
from fabulist.models import Base, User
...
class Fabulist:
    """Main application class for Fabulist
    ...
    -----------
    _instance: Fabulist
        The instance of the Fabulist class
    _engine: Engine
        The database engine
    _session: Session
    ...
    Methods:
    --------
    __new__(cls, path_to_config: str) -> Fabulist
    ...
    def __new__(cls, path_to_config: str):
        ...
        if cls._instance is None:
            cls._instance = super(Fabulist, cls).__new__(cls)
    ...
    def __str__(self):
        return "Fabulist Application [Version 0.1.5]"
